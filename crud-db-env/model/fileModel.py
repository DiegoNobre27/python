...
class FileModel():
    ...
    def createFilterFile(self, fileName=None, fileType=None):
        fileName_lower = TransformTextModel.convertTextOrListLowerCase(textOrList=fileName)
        fileType_lower = TransformTextModel.convertTextOrListLowerCase(textOrList=fileType)
